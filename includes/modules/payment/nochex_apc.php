...
// class constructor - No registration with Nochex necessary to pay with your credit or debit card
		function nochex_apc() {
			global $order;
			$this->code = 'nochex_apc';
			$this->title = 'Credit or Debit Card (via Nochex)';
			$this->description = "Nochex APC Plugin by <a href=\"https://www.nochex.com\" target=\"_blank\" style=\"color:darkblue;font-style:italic;\">Nochex</a>";
		...
		if (is_object($order)) $this->update_status(); 
			$this->form_action_url = tep_href_link('ext/modules/payment/nochex/nochex.php', '', 'SSL');
		}
